...
from tradinghub.backend.shared.services.short_backtest_service import ShortBacktestService

class ShortBacktestController:
    """Controller for handling SHORT position backtest requests"""
    
    def __init__(self):
        self.backtest_service = ShortBacktestService()

    def run_backtest(self, data: Dict[str, Any]) -> tuple[Dict[str, Any], int]:
        """
        Handle SHORT position backtest request
